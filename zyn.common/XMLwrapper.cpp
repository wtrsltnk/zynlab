...
void XMLwrapper::addparunsigned(const string &name, unsigned int val)
{
...
unsigned int XMLwrapper::getparunsigned(const string &name, unsigned int defaultpar, unsigned int min,
